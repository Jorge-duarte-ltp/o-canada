...
const DatosAyuda = ({ setShow, show }) => {
    ...
    const contactosIncendios = [
        ...
        { region: 'Occidente', nombre: 'Juvenal Rodríguez Villa', telefono: '(341) 413 6401   ||   (341) 413 6478', celular: '(341) 122 5490', extension: '9760', correo: 'juvenal.rodriguez@conafor.gob.mx' },
