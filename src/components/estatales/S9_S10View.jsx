            ...
            <div className='row body_wrap'>
                ...
                <div className='col-12 col-md-12'>
                    <a className='btn btn-dark'
                        href={`http://187.218.230.38:81/o_canada_sisecoif/archivos/${evaluaciones.curp}/formato.pdf`}
                ...
                {sectionEPP && <React.Fragment>
                    ...
                    <div className='col-12 col-md-12'>
                        <a className='btn btn-dark'
                            href={`http://187.218.230.38:81/o_canada_sisecoif/archivos/${evaluaciones.curp}/formato_epp.pdf`}
                            rel="noopener noreferrer"
                            target='_blank'>
                ...
                {sectionGPSMark && <React.Fragment>
                    ...
                    <div className='col-12 col-md-12'>
                        <a className='btn btn-dark'
                            href={`http://187.218.230.38:81/o_canada_sisecoif/archivos/${evaluaciones.curp}/formato_eval_habilidad_uso_gps.pdf`}
                            rel="noopener noreferrer"
                            target='_blank'>
                            Formato de evaluación habilidad y competencia en el uso de GPS
                        </a>
                    ...
                    <div className='col-12 col-md-12'>
                        <a className='btn btn-dark'
                            href={`http://187.218.230.38:81/o_canada_sisecoif/archivos/${evaluaciones.curp}/formato_eval_habilidad_uso_mark_III.pdf`}
                            rel="noopener noreferrer"
                            target='_blank'>
                            Formato de evaluación habilidad y competencia en el uso de Mark III
                        </a>
