...
const S9_S10 = (props) => {
  ...
  const sendData = async () => {
    ...
    if (sePresento === "1" && archivos.formato) {
      ...
      if (sectionGPSMark && archivos.formato_eval_habilidad_uso_gps && archivos.formato_eval_habilidad_uso_mark_III && archivos.formato_eval_habilidad_uso_motosierra) {
        ...
        if (
          ...
          AlertExito("Se cargo archivos GPS, MARK y MOTOSIERRA con exito!");
        } else {
          AlertError("Error al cargar archivos GPS, MARK y MOTOSIERRA ");
        }
      }
        ...
        <React.Fragment>
          ...
          {sectionGPSMark && (
            <React.Fragment>
              {/* ENCABEZADO */}
              <div className="col-12 col-md-12 center-text pt-5">
                <h2>GPS, Motobomba MARK III y Motosierra</h2>
              </div>
